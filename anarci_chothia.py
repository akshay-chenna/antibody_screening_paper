...
def run_functions(var1,var2):
    try:
        renumber_pdb(var1,var2)
    except:
        pass
...
with open('list.txt') as f:
    for line in f:
        x = line.strip('\n')
        renumber_pdb('oas_paired95_flat-igfold/'+x,'renumbered/'+x)
'''
...
Parallel(n_jobs=90)(delayed(run_functions)('oas_paired95_flat-igfold/'+x,'renumbered/'+x) for x in lines)
